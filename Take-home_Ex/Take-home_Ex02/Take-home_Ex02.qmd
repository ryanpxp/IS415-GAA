...
![Phuket Region](data\raw\Phuket_region.png){width="100%" style="object-fit: contain;"} Looking at the map, we can see that while **Phuket** is disconnected by water body, we can considered it to be the neighbour of **Phangnga**.
