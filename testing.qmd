...
::: {style="font-size: 1.5em"}
```{r}
condo_resale <- read_csv("In-class_Ex/In-class_Ex10/data/aspatial/Condo_resale_2015.csv")

mpsz = st_read(dsn = "In-class_Ex/In-class_Ex10/data/geospatial", layer = "MP14_SUBZONE_WEB_PL")

condo_resale_sf <- read_rds(
  "In-class_Ex/In-class_Ex10/data/rds/condo_resale_sf.rds")
```
:::
:::
